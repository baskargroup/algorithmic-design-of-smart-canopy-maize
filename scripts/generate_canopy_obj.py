...
CATALOG_PATH = "catalog/sim_catalog.parquet"
...
def generate_one_canopy(
    ...
    # Expected output path (so we can optionally skip without recomputing)
...
def main():
    ...
    parser.add_argument("--catalog", type=str, default=CATALOG_PATH,
                        help="Path to sim_catalog.parquet")
    ...
    # Chunking controls (preferred for multi-node)
    ...
    # Safety: ensure requested ids exist in catalog
